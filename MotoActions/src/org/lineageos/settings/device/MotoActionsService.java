...
import org.lineageos.settings.settings.device.actions.ChopChopSensor;
import org.lineageos.settings.settings.device.actions.FlipToMute;
import org.lineageos.settings.settings.device.actions.LiftToSilence;
import org.lineageos.settings.settings.device.actions.ProximitySilencer;
import org.lineageos.settings.settings.device.actions.UpdatedStateNotifier;
import org.lineageos.settings.settings.device.doze.DozePulseAction;
import org.lineageos.settings.settings.device.doze.FlatUpSensor;
import org.lineageos.settings.settings.device.doze.ScreenStateNotifier;
import org.lineageos.settings.settings.device.doze.StowSensor;
